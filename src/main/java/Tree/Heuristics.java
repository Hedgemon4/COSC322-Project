...
//        System.out.println("put took " + (end - start) + "ns");
    ...
    private static int[][] D1(State s) {
        ...
        for (int nMoves = 0; nMoves < 10; nMoves++) {
            ...
            result = queenReachableInOneMove(State.BLACK_QUEEN, input);
        ...
        for (int nMoves = 0; nMoves < 10; nMoves++) {
            // Find all reachable squares
            result = queenReachableInOneMove(State.WHITE_QUEEN, input);
     ...
     */
    private static BitBoard queenReachableInOneMove(int color, BitBoard b) {
        // Constants
...
//        return new long[]{reachableTop, reachableBottom};
    ...
    public static BitBoard queenReachableInOneMove(BitBoard b) {
        // Constants
        long columnMask = 0b00000000010000000001000000000100000000010000000001L;
        long rowMask = 0b1111111111L;
        long diagonalMask = 0b10000000000100000000001000000000010000000000100000000001L;
